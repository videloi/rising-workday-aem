 ...
 */
package com.risingworkday.wepsite.aem.core.models;
...
import com.risingworkday.wepsite.aem.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "risingworkday.website.aem/components/helloworld");
